  ...
  return (
    <>
      <div className="container">
        ...
        <p style={{ textDecoration: "underline" }}>Click an Image</p>
        <div className="image-container">
          {images.map((image, index) => (
            ...
            >
              <img src={image} className="gallery-image"></img>
            </div>
          ))}
        </div>
        {selectedImage && (
          <div className="selected-image">
            <h2 style={{ fontSize: "1.5rem" }}>Selected Image</h2>
            <img src={selectedImage} className="selected-img"></img>
          </div>
        )}
      </div>
    </>
